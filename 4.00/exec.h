...
struct TreeNode * exec_statement      (struct TreeNode *);
struct TreeNode * exec_scope          (struct TreeNode *);
...
struct TreeNode * exec_while          (struct TreeNode *);
struct TreeNode * exec_ifElse         (struct TreeNode *);
struct TreeNode * exec_if             (struct TreeNode *);
