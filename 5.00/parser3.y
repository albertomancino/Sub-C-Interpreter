...
| END_COMMA
| syntax_error                                                                   {printf("%sVariable or function declaration expexted.\nFound: \'%s\'\n", ErrorMsg(), $1);}
;

syntax_error
: error                                                                         {$$ = malloc(sizeof(char) * yylen); strcpy($$, yytext); yyerrok; yyclearin;}
| syntax_error error                                                            {char * str = malloc(sizeof(char) * yylen + strlen($1) + 1); strcpy(str, $1); strcat(str, " "); strcat(str, yytext); free($$); $$ = str; yyerrok; yyclearin;}
;
...
//| function_list error {yyerrok; yyclearin;}
;
