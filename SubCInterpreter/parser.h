...
void Check_CharSemantic                               (int);
void Check_IdentifierSemantic                         (struct TreeNode *);
void Check_ArraySemantic                              (struct TreeNode *);
void Check_VariableSemantic                           (struct TreeNode *);
void Check_FunctionCallSemantic                       (struct TreeNode *);
void Check_PrintfCallSemantic                         (struct TreeNode *);
void Check_ScanfCallSemantic                          (struct TreeNode *);
void Check_OperationSemantic                          (struct TreeNode *);
void Check_ComparisonSemantic                         (struct TreeNode *);
void Check_AsgnSemantic                               (struct TreeNode *, struct TreeNode *);
void Check_DeclSemantic                               (struct TreeNode *);
