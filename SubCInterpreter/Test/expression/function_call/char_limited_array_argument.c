int fun_costant(char a[10], char b[10], char c[10]){
...
int fun_variable(char a[10], char b[10], char c[10], char d[10]){
...
int fun_int_array_pointer(char a[10]){
...
int fun_char_array_pointer(char a[10]){
...
int fun_string(char a[10]){

  printf("\n");
  printf("OK. String pointer : %s.\n", a);

  return 0;
}

int fun_function_call(char a[10], char b[10]){
...
int fun_increment_decrement(char a[10], char b[10], char c[10], char d[10]){
...
int fun_variable_pointers(char a[10], char b[10], char c[10], char d[10], char e[10], char f[10]){
...
int test(){
  ...
  //fun_int_array_pointer(int_array); //error
