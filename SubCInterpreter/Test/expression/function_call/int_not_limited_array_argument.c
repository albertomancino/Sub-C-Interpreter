int fun_costant(int a[], int b[], int c[]){
...
int fun_variable(int a[], int b[], int c[], int d[]){
...
int fun_int_array_pointer(int a[], int dimension){
...
int fun_char_array_pointer(int a[], int dimension){
...
int fun_function_call(int a[], int b[]){
...
int fun_increment_decrement(int a[], int b[], int c[], int d[]){
...
int fun_variable_pointers(int a[], int b[], int c[], int d[], int e[], int f[]){
...
int test(){
  ...
  fun_int_array_pointer(int_array, 5);
